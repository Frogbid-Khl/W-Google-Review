        ...
        <div class="row mt-2">
            ...
            <div class="col-lg-6 mt-3">
                ...
                <form method="post" action="form_submit.php">
                    ...
                    <input type="hidden" name="page" class="form-control" value="trustpilot">
                    <div class="mb-3">
                        <div class="row">
                ...
                <div class="accordion" id="accordionExample">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body description">
                                ...
                                <p>
                                    ...
                                    impossible, but it’s a daunting task.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item mt-3">
                        ...
                        <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven"
                            ...
                            <div class="accordion-body description">
                                <p>
                                    You should always look to make sure that the website is secured with SSL encryption
                                    and isn’t going to put you at risk. There should be a little lock in the address bar
                                    of the website which indicates that the site is secure.
                                </p>
                                <p>
                                    If it’s not, your data and/or device may be in jeopardy of hacking efforts and other
                                    issues. Also check to verify that the payment gateways are secure so that your
                    ...
                    <div class="accordion-item mt-3">
                        ...
                        <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                            ...
                            <div class="accordion-body description">
                                <p>
                                    Delivery time is another important factor when deciding which company to buy from.
                                    You may see different options like instant delivery or drip delivery, which spreads
                                    your order out and makes the delivery look more natural.
                                </p>
                                <p>
                                    Think about what options you have and make sure the company offers you either
                                    options or reasonable delivery times that will keep your account safe.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item mt-3">
                        <h2 class="accordion-header" id="headingTen">
                            <button class="accordion-button collapsed box-caption" type="button"
                                ...
                                FAQ Page and Information on the Service
                            </button>
                        </h2>
                        <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen"
                            ...
                            <div class="accordion-body description">
                                <p>
                                    The more information the company offers about their services, the better. Look
                                    closely at the FAQ page to make sure that you understand how the service works and
                                    what they will offer you. If the company doesn’t offer a lot of information about
                                    their services or doesn’t have a FAQ at all, it’s best not to buy from them as they
                                    are not being upfront with their clients.
                                </p>
                            </div>
                        </div>
                    </div>
